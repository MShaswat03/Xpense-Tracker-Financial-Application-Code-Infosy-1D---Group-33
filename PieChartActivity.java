...
public class PieChartActivity extends DemoBase implements OnSeekBarChangeListener,
    ...
    private void setData(int count, float range) {
        ...
        for (int i = 0; i < count ; i++) {
            entries.add(new PieEntry((float) ((Math.random() * range) + range / 5),
                    ...
                    getResources().getDrawable(R.drawable.green_shape)));
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
            ...
            if( item.getItemId() == R.id.actionToggleHole) {
            ...
            if(item.getItemId() == R.id.actionToggleMinAngles) {
            ...
            if(item.getItemId() ==  R.id.actionToggleCurvedSlices) {
            ...
            if( item.getItemId() == R.id.actionDrawCenter) {
            ...
            if(item.getItemId() == R.id.actionToggleXValues) {
